...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/v-v-r-official/FM-RASHMIKABOT)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ALENTL/FM-RASHMIKABOT) 


## Credits
The bot is based on the original work done by [ALENTL](https://github.com/ALENTL)
...
Should any be missing kindly let us know at [RASHMIKA Support](https://t.me/ALEN_TL) or simply submit a pull request on the readme.
